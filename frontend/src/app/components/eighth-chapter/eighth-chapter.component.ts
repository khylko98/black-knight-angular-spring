...
@Component({
  selector: 'app-eighth-chapter',
  templateUrl: './eighth-chapter.component.html',
  styleUrls: ['./eighth-chapter.component.css'],
  providers: [MessageService],
})
export class EighthChapterComponent implements OnInit {
  ...
  toNextChapter() {
    this.router.navigate(['ninth_chapter']);
  }
}
